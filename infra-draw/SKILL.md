...
- 출력: `{프로젝트}/docs/infrastructure.html`
...
2. `{프로젝트경로}/docs/infrastructure.html` 파일을 Write 도구로 생성
3. 생성 완료 후 메시지 출력: `docs/infrastructure.html 파일을 생성했습니다. 브라우저에서 열어 확인하세요.`
