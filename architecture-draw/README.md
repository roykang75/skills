...
# 업데이트 (심볼릭 링크인 경우 git pull만으로 반영)
...
`/plugin` 명령으로도 관리할 수 있습니다.

```bash
# 마켓플레이스 추가 후 설치
/plugin marketplace add roykang75/skills
/plugin install architecture-draw@roykang75-skills

# 삭제
/plugin uninstall architecture-draw@roykang75-skills

# 업데이트
/plugin marketplace update roykang75-skills
